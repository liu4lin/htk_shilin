...
prefix = /Users/shilin/work/htk_shilin
exec_prefix = ${prefix}
...
CC = gcc
CPPFLAGS = 
CFLAGS = $(CPPFLAGS) -ansi -g -DNO_AUDIO -D'ARCH="darwin"' -I/usr/include/malloc -Wall -Wno-switch -g
...
install: install-htktools install-hdecode
docs: book
