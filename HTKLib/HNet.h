...
#ifdef PRTSMU
   float finfo[1];   /* Frame Level information, e.g. likelihood, time varying mean or more*/
#endif
   float* aux;
}
LAlign;
...
typedef struct larc
{
   ...
   IntVec *slAlign;   /* Array[0..nAlign-1][1...T] 3 state alignments of each records in word*/
   HLink *hmms;
