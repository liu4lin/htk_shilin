...
*/
/*64 bit version, local machine*/
#define MARK_ALTPATH_MASK     0x0000000000000001UL
#define MARK_ALTPATH(a)         (a->prev = (long)(a->prev) | MARK_ALTPATH_MASK)
#define MARKED_ALTPATH_P(a)     ((long)((a)->prev) & MARK_ALTPATH_MASK)
#define UNMARK_ALTPATH(a)       (a->prev = (long)(a->prev) & ~MARK_ALTPATH_MASK)
...
#define MARK_MODPATH(m)         (m->ln = (long)((m)->ln) | MARK_MODPATH_MASK)
#define MARKED_MODPATH_P(m)     ((long)((m)->ln) & MARK_MODPATH_MASK)
#define UNMARK_MODPATH(m)       (m->ln = (long)((m)->ln) & ~MARK_MODPATH_MASK)
